...
export default function LiveDrawClient({ eventId }: { eventId: string }) {
  ...
  return (
    <div className="ld-dark" style={{ maxWidth: 1080, minHeight: '100vh', fontFamily: "'Hanken Grotesk', 'Inter', sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Hanken+Grotesk:ital,wght@0,100..900;1,100..900&family=Anybody:ital,wght@0,100..900;1,100..900&family=JetBrains+Mono:ital,wght@0,100..800;1,100..800&display=swap');
        .ld-dark, .ld-dark * { box-sizing: border-box; }
        .ld-dark { background: #0e0e0e; color: #e5e2e1; padding: 28px; font-family: 'Hanken Grotesk', sans-serif; }

        /* Typography overrides */
        .ld-dark h1 { font-family: 'Anybody', sans-serif !important; font-style: italic !important; text-transform: uppercase !important; letter-spacing: -0.02em !important; color: #e5e2e1 !important; }
        .ld-dark h2 { font-family: 'Anybody', sans-serif !important; font-style: italic !important; text-transform: uppercase !important; color: #e5e2e1 !important; }
        .ld-dark p, .ld-dark span, .ld-dark div, .ld-dark label { color: #e5e2e1; }

        /* Card / panel resets */
        .ld-dark [style*="background: rgb(255, 255, 255)"],
        .ld-dark [style*="background: white"],
        .ld-dark [style*="background:white"] { background: #1c1b1b !important; color: #e5e2e1 !important; }
        .ld-dark [style*="background: rgb(243"] { background: #141414 !important; }
        .ld-dark [style*="background: rgb(249"] { background: #1c1b1b !important; }
        .ld-dark [style*="background: rgb(239"] { background: #2a2a2a !important; }
        .ld-dark [style*="background: rgb(248"] { background: #1c1b1b !important; }

        /* Borders */
        .ld-dark [style*="border: 1px solid rgb(229"] { border-color: #2a2a2a !important; }
        .ld-dark [style*="border: 1px solid rgb(209"] { border-color: #353534 !important; }
        .ld-dark [style*="border: 2px solid"] { border-color: #353534 !important; }

        /* Text colors: dark on white -> light */
        .ld-dark [style*="color: rgb(17"] { color: #e5e2e1 !important; }
        .ld-dark [style*="color: rgb(0"] { color: #e5e2e1 !important; }
        .ld-dark [style*="color: rgb(55"] { color: #c8c4c3 !important; }
        .ld-dark [style*="color: rgb(107"] { color: #9a9693 !important; }
        .ld-dark [style*="color: rgb(75"] { color: #c8c4c3 !important; }

        /* Buttons — primary */
        .ld-dark button[style*="background: rgb(37, 99"] { background: #ff0000 !important; border-color: #ff0000 !important; color: #fff !important; clip-path: polygon(6px 0%, 100% 0%, calc(100% - 6px) 100%, 0% 100%) !important; }
        .ld-dark button[style*="background: rgb(79, 70"] { background: #ff0000 !important; border-color: #ff0000 !important; color: #fff !important; }
        .ld-dark button[style*="background: rgb(99, 102"] { background: #ff0000 !important; border-color: #ff0000 !important; color: #fff !important; }

        /* Buttons — neutral */
        .ld-dark button { border-radius: 0 !important; font-family: 'Hanken Grotesk', sans-serif !important; font-weight: 800 !important; letter-spacing: 0.05em !important; text-transform: uppercase !important; transition: opacity 0.15s !important; }
        .ld-dark button:not([disabled]):hover { opacity: 0.85 !important; }
        .ld-dark button[style*="background: rgb(229"] { background: #2a2a2a !important; border-color: #353534 !important; color: #e5e2e1 !important; }
        .ld-dark button[style*="background: rgb(243"] { background: #1c1b1b !important; border-color: #2a2a2a !important; color: #e5e2e1 !important; }
        .ld-dark button[disabled] { opacity: 0.35 !important; cursor: not-allowed !important; }

        /* Inputs / selects */
        .ld-dark input[type="text"],
        .ld-dark input[type="number"],
        .ld-dark select,
        .ld-dark textarea {
        ...
        .ld-dark input:focus, .ld-dark select:focus { border-color: #ff0000 !important; box-shadow: 0 0 0 2px rgba(255,0,0,0.2) !important; }
        .ld-dark option { background: #1c1b1b; color: #e5e2e1; }

        /* Radio / checkbox accent */
        .ld-dark input[type="radio"], .ld-dark input[type="checkbox"] { accent-color: #ff0000 !important; }

        /* Section dividers */
        .ld-dark hr { border-color: #2a2a2a !important; }

        /* Badges / pills */
        .ld-dark [style*="background: rgb(239, 246"] { background: #1a0000 !important; color: #ff6b6b !important; border-radius: 0 !important; }
        .ld-dark [style*="background: rgb(240, 253"] { background: #001a00 !important; color: #2ecc71 !important; }
        .ld-dark [style*="background: rgb(254, 249"] { background: #1a1500 !important; color: #e9c400 !important; }

        /* Scrollbar */
        .ld-dark *::-webkit-scrollbar { width: 6px; height: 6px; }
        .ld-dark *::-webkit-scrollbar-track { background: #0e0e0e; }
        .ld-dark *::-webkit-scrollbar-thumb { background: #353534; border-radius: 0; }
        .ld-dark *::-webkit-scrollbar-thumb:hover { background: #ff0000; }

        /* Header accent bar */
        .ld-dark > div:nth-child(2) { border-bottom: 2px solid #ff000040 !important; padding-bottom: 16px !important; margin-bottom: 20px !important; }

        /* Panels / cards – give them carbon border */
        .ld-dark > div:nth-child(3),
        .ld-dark > div:nth-child(4) { border: 1px solid #2a2a2a; background: #141414 !important; padding: 16px !important; margin-bottom: 16px !important; }

        /* Canvas / wheel glow */
        .ld-dark canvas { box-shadow: 0 0 40px rgba(255,0,0,0.25) !important; }

        /* Modal overlay */
        .ld-dark [style*="position: fixed"][style*="inset: 0"] { background: rgba(0,0,0,0.85) !important; backdrop-filter: blur(4px) !important; }

        /* Alert / info box */
        .ld-dark [style*="background: rgb(254, 243"] { background: #1a1500 !important; border-color: #e9c40040 !important; color: #e9c400 !important; }
        .ld-dark [style*="background: rgb(220, 252"] { background: #001a00 !important; border-color: #2ecc7130 !important; color: #2ecc71 !important; }
        .ld-dark [style*="background: rgb(254, 226"] { background: #1a0000 !important; border-color: #ff000030 !important; color: #ff6b6b !important; }

        /* Red accent pulse animation */
        @keyframes ld-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.4; } }
        .ld-dark [style*="border-radius: 50%"][style*="background: rgb(239, 68"] { background: #ff0000 !important; animation: ld-pulse 2s infinite !important; }
      `}</style>
      <iframe
        ref={printFrameRef}
